    ...
    public async Task The_document_is_served_without_a_token_and_names_every_endpoint()
    {
        ...
        Assert.Equal(
            [
                ...
                "/me", "/me/email", "/me/metadata", "/me/password", "/me/token",
                "/pages", "/password-recovery", "/password-recovery/complete",
                ...
                "/spaces", "/spaces/{name}", "/spaces/{name}/pages", "/spaces/{name}/pages/move", "/spaces/{name}/pages/restore",
                "/spaces/{name}/pages/{path}", "/spaces/{name}/restore", "/spaces/{name}/users", "/spaces/{name}/users/{id}",
                "/standing",
