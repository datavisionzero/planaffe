    ...
    public async Task The_tables_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "issue", "issue_label", "label", "one_time_secret", "page", "page_label", "project", "project_access", "question", "release", "release_issue",
                "space", "space_access", "token",
            ],
            tables);
    }
    ...
    public async Task The_indexes_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "pk_release_issue", "pk_space", "pk_space_access", "pk_token", "project_access_user", "project_key", "question_issue", "question_open", "question_search", "release_issue_issue",
                "release_name", "release_open", "space_access_user", "space_name", "token_agent", "token_secret_hash",
            ],
            indexes);
