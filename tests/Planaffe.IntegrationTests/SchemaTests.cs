    ...
    public async Task The_tables_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "issue", "issue_label", "label", "one_time_secret", "project", "project_access", "question", "release", "release_issue",
                "space", "space_access", "space_page", "token",
            ],
            tables);
    }
    ...
    public async Task The_indexes_are_the_ones_storage_md_declares()
    {
        ...
        Assert.Equal(
            [
                ...
                "epic_number", "history_epic", "history_issue", "history_space_page",
                ...
                "one_live_login_per_code", "one_live_secret_per_purpose", "one_time_secret_hash",
                "pk_blocker", "pk_browser_session", "pk_comment", "pk_device_login", "pk_epic", "pk_epic_label", "pk_history", "pk_idempotency",
                "pk_identity", "pk_identity_metadata", "pk_issue", "pk_issue_label", "pk_label", "pk_one_time_secret", "pk_project", "pk_project_access", "pk_question", "pk_release",
