...
// Markdown pipeline shared with draft recovery, and the confetti arrive after
// the frame rather than in it (ADR 0006), and they are found by
...
const measured = {
  ...
  markdown: afterTheFrame("markdown", "useDraft"),
